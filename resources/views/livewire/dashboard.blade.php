        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="d-flex flex-wrap flex-stack mb-6">
                    <!--begin::Title-->
                    <h3 class="fw-bold my-2">Statistiques 2025
                    <!--end::Title-->
                </div>
                <!--end::Toolbar-->
                <!--begin::Row-->
                            ...
                            <div class="card-body d-flex flex-column px-9 pt-6 pb-8">
                                ...
                                <div class="row g-6 g-xl-9">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Heading-->
                                        <div>
                                            <div class="fs-2tx ">{{$googleUsersCount25}}</div>
                                        </div>
                                        <!--end::Heading-->
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Heading-->
                                        <div>
                                            <div class="fs-2tx ">{{$facebookUsersCount25}}</div>
                                        </div>
                                        <!--end::Heading-->
                                    </div>
                                ...
                                <!--end::Row-->
                                		<!--begin::Indicator-->
													<div class="d-flex align-items-center fw-semibold mt-10">
														<span class="badge bg-light text-gray-700 px-3 py-2 me-2">{{$allUsersCount25}}</span>
                            ...
                            <div class="card-body d-flex flex-column px-9 pt-6 pb-8">
                                ...
                                <div class="row g-6 g-xl-9">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Heading-->
                                        <div>
                                            <div class="fs-2tx ">{{$femmeUsersCount25}}</div>
                                        </div>
                                        <!--end::Heading-->
                                    </div>
                                    <!--end::First Heading and Icon-->
                                    ...
                                    <div class="col-sm-6 col-xl-6">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Heading-->
                                            <div>
                                                <div class="fs-2tx ">{{$hommeUsersCount25}}</div>
                                            </div>
                                            <!--end::Heading-->
                                        </div>
                                        <!--end::First Heading and Icon-->
                            ...
                            <div class="card-body d-flex flex-column px-9 pt-6 pb-8">
                                ...
                                <div class="row g-6 g-xl-9">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Heading-->
                                        <div>
                                            <div class="fs-2tx ">{{$amateurUsersCount25}}</div>
                                        </div>
                                        <!--end::Heading-->
                                    </div>
                                    <!--end::First Heading and Icon-->
                                    ...
                                    <div class="col-sm-6 col-xl-6">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Heading-->
                                            <div>
                                                <div class="fs-2tx ">{{$proUsersCount25}}</div>
                                            </div>
                                            <!--end::Heading-->
                                        </div>
                                        <!--end::First Heading and Icon-->
                            ...
                            <div class="card-body col-sm-12 d-flex flex-column px-9 pt-6 pb-8">
                                ...
                                <table class="table align-middle gs-0 gy-4">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a class="ps-20 text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{$countUnderEighteen25}}</a>
                                            </td>
                                            <td>
                                                <a class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{$countBetweenEighteenAndThirty25}}</a>
                                            </td>
                                            <td>
                                                <a class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{$countBetweenThirtyAndSixty25}}</a>
                                            </td>
                                            <td>
                                                <a class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{$usersOverSixty25}}</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <!--end::Table body-->
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table align-middle gs-0 gy-4   table-row-bordered table-row-solid gy-4 gs-9">
                                        ...
                                        <tbody class="fw-6 fw-semibold text-gray-600">
                                            @foreach ($userCountsParRegions25 as $userCountsParRegion)
                ...
                <div class="d-flex flex-wrap flex-stack mt-6">
                    <!--begin::Title-->
                    <h3 class="fw-bold mt-2">Statistiques 2024
                    <!--end::Title-->
                </div>
                <!--end::Toolbar-->
                <!--begin::Row-->

    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="d-flex flex-wrap flex-stack mb-6">
                <!--begin::Title-->
                <h3 class="fw-bold my-2">Liste de mes évaluations
                    <!--end::Title-->
            </div>
            <!--end::Toolbar-->
                        ...
                        <table class="table align-middle gs-0 gy-4" id="ratingsTable">
                            ...
                            <thead>
                                <tr class="fw-bold text-muted bg-light">
                                    ...
                                    <th class="min-w-100px">Évaluation</th>
                            ...
                            <tbody>
                                @foreach ($participations as $participation)
                                    <tr data-category-id="{{ $participation->categorie->id }}">
                                        ...
                                        @php
                                            $rating = $ratings->where('participation_id', $participation->id)->first();
                                        @endphp
                                        <td >
                                            @if ($rating)
                                        ...
                                        <td>
                                            ...
                                            data-image-rating="{{ $rating->rating }}"
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6 mt-md-5 mt-sm-5">
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <form id="rating-form" class="py-6 px-4"  method="POST" autocomplete="off">
                                                @csrf
                                                @method('PUT')
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-error font-weight-bold delete-sure" style="background-color: rgb(255, 62, 62); color: white;">Supprimer</button>
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function() {
        ...
        $(document).on('click', '.rating-btn', function () {
            ...
            var rating = $(this).data('image-rating');

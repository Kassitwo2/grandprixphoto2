                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-5">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <a class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Participations stand by</a>
                            </h3>
                            <!--end::Title-->
                        </div>
                        <!--end::Header-->
                                                                    ...
                                                                    <a class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                // Display error message if there's an error reading EXIF data
                                                                                echo '<a class="text-dark fw-bold text-hover-primary d-block text-center mb-1 fs-6 badge badge-danger">NULL</a>';
                                                                            }
                                                                        ?>
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                if($xResolution < 300 || $yResolution <300){
                                                                                    ...
                                                                                    echo '<a class="text-dark fw-bold text-hover-primary  d-block text-center mb-1 fs-6 ">' . $xResolution ." / ". $yResolution. '</a>';
                                                                                }

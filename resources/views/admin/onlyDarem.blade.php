                                                        ...
                                                        <table class="table align-middle gs-0 gy-4">
                                                            ...
                                                            <thead>
                                                                <tr class="fw-bold text-muted bg-light">
                                                                    ...
                                                                    <th class="ps-18 min-w-125px rounded-start">image</th>
                                                                    <th class="min-w-125px">name</th>
                                                                    <th class="min-w-125px">Profile</th>
                                                                    <th class="min-w-125px">telephone</th>
                                                                    <th class="min-w-125px">Email</th>

                                                                    <th class="min-w-125px rounded-end">ville</th>
                                                                </tr>
                                                            </thead>
                                                            <!--end::Table head-->
                                                            <!--begin::Table body-->
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="symbol symbol-50px me-5">
                                                                                <a href="#" class="symbol symbol-50px m-3 image-modal-link" data-image-detail="{{ $userCountsParRegion->photo }}" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">
                                                                                    <span class="symbol-label bg-light">
                                                                                        <img src="{{ $userCountsParRegion->photo }}" style="width: 100%; height: 100%; object-fit: cover; position: absolute; top: 0; left: 0;" alt="">
                                                                                    </span> 
                                                                                </a>                                                                         
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <a class="ps-20 text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{$userCountsParRegion->name}}</a>
                                                                    </td>
                                                                    <td>
                                                                        <a class="ps-15 text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{$userCountsParRegion->profile}}</a>
                                                                    </td>
                                                                    <td>
                                                                        <a class="ps-15 text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{$userCountsParRegion->phone}}</a>
                                                                    </td>
                                                                    <td>
                                                                        <a class="ps-15 text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{$userCountsParRegion->email}}</a>
                                                                    </td>
                                                                    <td>
                                                                        <a class="ps-5 text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{$userCountsParRegion->ville}}</a>
                                                                    </td>
                                                                </tr>
                                                                @endforeach

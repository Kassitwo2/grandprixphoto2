							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Les admins</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Les admins</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
                                        ...
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Ajouter Admin  </button>
										<!--end::Primary button-->
									</div>
									<!--end::Actions-->
								</div>
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<tbody class="fw-semibold text-gray-600">
													...
													<tr>
														...
														<td>
															<span class="text-gray-600 text-hover-primary mb-1">{{$admin->email}}</span>
														</td>
                                                        ...
                                                        <td class="text-end">
                                                            <div class="d-flex justify-content-end flex-shrink-0">
                                                                ...
                                                                <a id="delete-admin-btn"  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete-admin-btn"  data-admin-id="{{ $admin->id }}">
									...
									<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
										...
										<div class="modal-dialog modal-dialog-centered mw-650px">
											...
											<div class="modal-content">
												<!--begin::Form-->
												<form  class="form" action="{{ route('save-admin') }}" method="POST" id="kt_modal_add_customer_form">
													<!--begin::Modal header-->
                                                    @csrf
													<div class="modal-header" id="kt_modal_add_customer_header">
														<!--begin::Modal title-->
														<h2 class="fw-bold">Ajouter Admin</h2>
														<!--end::Modal title-->
														<!--begin::Close-->
													...
													<div class="modal-body py-10 px-lg-17">
														...
														<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
															...
															<!--end::Input group-->
                                                            <input type="text" hidden value="1"  class="form-control form-control-solid" name="is_Admin" >
															<!--begin::Input group-->
                                    ...
                                    <div class="modal fade" id="kt_modal_update_customer" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            ...
                                            <div class="modal-content">
                                                <!--begin::Form-->
                                                <form class="form" action="{{ route('update.admin') }}" method="POST" id="kt_modal_update_customer_form">
                                                    <!--begin::Modal header-->
                                                    @csrf
                                                    <input type="hidden" id="up_id" name="id">
                                                    <div class="modal-header" id="kt_modal_update_customer_header">
                                                        <!--begin::Modal title-->
                                                        <h2 class="fw-bold">Modifier admin</h2>
                                                        <!--end::Modal title-->
                                                        <!--begin::Close-->
    ...
    $(document).on('click', '.delete-admin-btn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('admins.adminDestroy', ':admin_id') }}".replace(':admin_id', adminId),
                        headers: {
                        ...
                        error: function(xhr, status, error) {
                            console.error(xhr.responseText);
                            alert('Échec de la suppression du admin');
                        }
                    });
                }
            });

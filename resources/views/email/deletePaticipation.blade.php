...
<table>
    ...
    <tr>
        <td width="50%" class="text-left" valign="top">
            <b>Confirmation de suppression de participation</b><br><br>
            Votre participation a été supprimée avec succès.<br><br>
        ...
        <td width="50%" class="text-right-rtl" valign="top">
            <b>تم حذف مشاركتك بنجاح</b><br><br>
            لقد قمت بحذف مشاركتك بنجاح.<br><br>
        <br><br>

...
<table>
    ...
    <tr>
        <td width="50%" class="text-left" valign="top">
            ...
            <br>
            <p>Nous vous informons que votre image ne respecte pas les règles du concours concernant le choix de la catégorie. Pour que votre participation soit valide, veuillez vous rendre dans votre espace de participation et corriger la catégorie.</p>
            <br><br>
        ...
        <td width="50%" class="text-right-rtl" valign="top">
            ...
            <br>
            <p>نحيطكم علماً بأن صورتكم لا تتوافق مع قواعد المسابقة فيما يتعلق باختيار الفئة. لضمان صحة مشاركتكم، يرجى الدخول إلى مساحة المشاركة الخاصة بكم وتصحيح الفئة.</p> <br><br>
            <br><br>

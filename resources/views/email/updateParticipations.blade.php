...
<table>
    ...
    <tr>
        <td width="50%" class="text-left" valign="top">
            <b>Confirmation de modification de participation</b><br><br>
            Votre participation a été modifiée avec succès. <br> Merci.<br><br>
        ...
        <td width="50%" class="text-right-rtl" valign="top">
            <b>عملية تعديل المشاركة</b><br><br>
            تم تعديل مشاركتك بنجاح. <br> شكراً.<br><br>
        <br><br>
